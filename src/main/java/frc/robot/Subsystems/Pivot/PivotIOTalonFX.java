...
public class PivotIOTalonFX implements PivotIO {
    ...
    public PivotIOTalonFX(){
        ...
        leftMotor1Configs.Slot0.kP = 8;
        leftMotor1Configs.Slot0.kI = 0;
        leftMotor1Configs.Slot0.kD = 0;
        leftMotor1Configs.Slot0.kS = 0;
        leftMotor1Configs.Slot0.kV = 0;
        leftMotor1Configs.Slot0.kA = 0;
        leftMotor1Configs.Slot0.kG = 0;
